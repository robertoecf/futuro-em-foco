  ...
  return (
    <div className="absolute inset-0 glass-card backdrop-blur-sm flex items-center justify-center z-10 rounded-lg">
      <div className="text-center">
        ...
        <h3 className="text-xl font-bold text-foreground mb-1">Otimizando exibição...</h3>
        <p className="text-foreground text-sm">Preparando visualização dos cenários finais</p>
      </div>
    </div>
  );
};
