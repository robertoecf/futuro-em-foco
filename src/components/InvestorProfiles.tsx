              ...
              <div className="space-y-2 text-sm text-white">
                  ...
                  <Tooltip open={openTooltips[`${profile.id}-volatility`]}>
                    ...
                    <TooltipContent>
                      <p className="max-w-xs">
                        A volatilidade mede o grau de variação dos preços de um investimento ao longo do tempo. 
                        Maior volatilidade significa que os preços podem subir ou descer mais rapidamente e 
                        em maior amplitude.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <Tooltip open={openTooltips[`${profile.id}-maxloss`]}>
                    ...
                    <TooltipContent>
                      <p className="max-w-xs">
                        O drawdown representa a maior queda percentual que o investimento pode sofrer 
                        em relação ao seu pico anterior. É uma medida de risco que indica a perda 
                        máxima esperada em cenários adversos.
                      </p>
                    </TooltipContent>
                  </Tooltip>
                </div>
